<!-- Space: Projects -->
<!-- Parent: ZshFlutter -->
<!-- Title: Contributing GithubFlow ZshFlutter -->
<!-- Label: ZshFlutter -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-flutter project on [GitHub](https://github.com/hadenlabs/zsh-flutter), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-flutter/pulls).
...
To follow the instructions in this guide and start contributing to zsh-flutter project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-flutter.git
```

Now your **upstream** points to **hadenlabs/zsh-flutter**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-flutter
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-flutter/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
